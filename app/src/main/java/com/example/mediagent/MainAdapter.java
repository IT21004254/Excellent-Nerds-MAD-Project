    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder,final int position, @NonNull MainModel model) {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // dialogPlus.show();
                ...
                EditText specialist = view.findViewById(R.id.txtSpecialist);
                EditText email = view.findViewById(R.id.txtemail);
                EditText hospital = view.findViewById(R.id.txtHospital);
                EditText durl = view.findViewById(R.id.txtImageUrl);
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Deleted data can't be Recover.");
